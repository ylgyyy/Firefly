...
![image.png|534](https://tu.fqzlr.com/file/blog/wenzhang/1777551944095_image.png)

终端执行 `node -v`、`npm -v`，输出版本号即成功。![image.png](https://tu.fqzlr.com/file/blog/wenzhang/1777696257686_image.png)**注意**：安装后重启终端，无效则重启电脑。
...
![image.png](https://tu.fqzlr.com/file/blog/wenzhang/1777696287079_image.png)

**注意**：网络超时切换手机热点。

### 3. 安装 Git

1.访问 https://git-scm.com/download/win，下载最新版并默认安装。![image.png](https://tu.fqzlr.com/file/blog/wenzhang/1777696402220_image.png)2. 一直下一步就行了，全程默认安装。

### 4. 安装 VS Code（可选）

1.访问 https://code.visualstudio.com/，下载并安装，勾选“创建桌面快捷方式”和“将 Code 加入 PATH”。

![image.png](https://tu.fqzlr.com/file/blog/wenzhang/1777696460697_image.png)

推荐安装中文插件。

![image.png](https://tu.fqzlr.com/file/blog/wenzhang/1777696528164_image.png)
...
```
name = "firefly"compatibility_date = "YYYY-MM-DD" # 更为今日
...
```
# 1. 设置你的GitHub用户名（就是你GitHub主页的用户名）git config --global user.name "你的GitHub用户名"
# 2. 设置你的GitHub绑定邮箱（就是你注册GitHub用的邮箱）git config --global user.email "你的GitHub邮箱"
```
